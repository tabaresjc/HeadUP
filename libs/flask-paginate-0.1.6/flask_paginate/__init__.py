...
ACTIVE_PAGE = '<li class="active"><a href="javascript:void(0);">{0}</a></li>'
LINK = '<li><a href="{0}">{1}</a></li>'
GAP_MARKER = '<li class="disabled"><a href="javascript:void(0);">...</a></li>'
DISABLED_PAGE = '<li class="disabled"><a href="javascript:void(0);">{0}</a></li>'
