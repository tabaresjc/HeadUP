...
class UsersView(FlaskView):
    ...
    def index(self):
        ...
        if not users.count() and page > 1:
            return render_template(url_for('UsersView:index_1'),
                                   redirect=True)
    ...
    def get(self, id):
        ...
        if user is None or not user.can_edit():
            ...
            return render_template(url_for('UsersView:index'),
                                   status=False,
                                   redirect=True,
                                   message=message)
    ...
    def post(self):
        ...
        if request.method == 'POST':
            ...
            if form.validate_on_submit():
                ...
                return render_template(url_for('UsersView:get', id=user.id),
                                       redirect=True,
                                       message=message)
            else:
    ...
    def hide_stamp(self, id, stamp_id):
        ...
        try:
            ...
            if post.is_hidden:
                ...
                return render_template(url_for('UsersView:get', id=id),
                                       redirect=True,
                                       message=message)
            else:
